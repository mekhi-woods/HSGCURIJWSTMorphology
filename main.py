...
import petroRadii.jwstpetrosian as pR
...
if __name__ == '__main__':
    ...
    hdr, data, err, datcrd, z1, z2 = pR.FITS_info(path=mainPath, wrkBin='SCI', errBin='ERR')

    # print("Displaying targets against data...")
    # targetPixCords, targetIDs, targetZs = jp.world_to_pix(data=data, path=targetPath, crds=datcrd, z1=z1, z2=z2,
    #                                                       show=True)
    ...
    #     time.sleep(
    #         PAUSE_TIME)  # Pause is necessary or matplotlib gets angry, if you get display errors then increase the time
